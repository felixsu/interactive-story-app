package felix.com.interactivestory.model;

import felix.com.interactivestory.R;

/**
 * Created by felix on 10/29/2015.
 * contains pre-defined page story
 */
public class Story {
    private Page[] mPages;
    ...
    public Story() {
        ...
        mPages[0] = new Page(
                ...
                new Choice("Stop and investigate", R.drawable.ic_launcher),
                new Choice("Continue home to Earth", R.drawable.ic_launcher));
        ...
        mPages[1] = new Page(
                ...
                new Choice("Explore the cave", R.drawable.ic_launcher),
                new Choice("Explore the rover", R.drawable.ic_launcher));
        ...
        mPages[2] = new Page(
                ...
                new Choice("Head back to Mars to investigate", R.drawable.ic_launcher),
                new Choice("Continue home to Earth", R.drawable.ic_launcher));
        ...
        mPages[3] = new Page(
                ...
                new Choice("Refill at ship and explore the rover", R.drawable.ic_launcher),
                new Choice("Continue towards the faint light", R.drawable.ic_launcher));
        ...
        mPages[4] = new Page(
                ...
                new Choice("Explore the coordinates", R.drawable.ic_launcher),
                new Choice("Return to Earth", R.drawable.ic_launcher));
